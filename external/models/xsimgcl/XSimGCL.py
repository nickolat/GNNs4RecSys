...
from .XSimGCLModel import XSimGCLModel
...
class XSimGCL(RecMixin, BaseRecommenderModel):
    r"""
    XSimGCL: Towards Extremely Simple Graph Contrastive Learning for Recommendation

    For further details, please refer to the `paper <https://dl.acm.org/doi/abs/10.1109/TKDE.2023.3288135>`_
    ...
    Args:
        ...
        l_star: The layer to be contrasted
        tau: Temperature
    ...
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        self._params_list = [
            ...
            ("_l_star", "l_star", "l_star", 1, int, None),
            ("_tau", "tau", "tau", 0.15, float, None)
        ]
        self.autoset_params()
